...
public class MainBottomSheetDialogFragment extends BottomSheetDialogFragment implements ProgressRequestBody.UploadCallbacks {
    ...
    public MainBottomSheetDialogFragment() {
    }
